...
// tasks
// 1.use while loopto sum numbers from 1 to 10
let x = 1
let sum = 0
while (x <= 10) {
    sum += x
...
console.log('The sum is:', sum) //The sum is: 55

// Using the link HERE , copy the array of JSON objects containing countries with their populations. 
// Display in an object showing how many countries have population between 0 - 50m, 51m - 100m, > 100m
//  as the keys
// e.g 
...
let i = 0
// create an object
let pop_lutation = {'0-50m': 0,'51-100m': 0,'>100m': 0,}
